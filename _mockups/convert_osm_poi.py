...
CATEGORY_LABELS = {
    ...
    'food_court': 'Food Court', 'bar': 'Bar', 'pub': 'Pub', 'ice_cream': 'Es Krim',
    'convenience': 'Minimarket', 'supermarket': 'Supermarket', 'mall': 'Mall',
    'marketplace': 'Pasar', 'department': 'Department Store', 'clothes': 'Pakaian',
    'electronics': 'Elektronik', 'mobile': 'Mobile', 'books': 'Buku',
    'photo': 'Fotografi', 'jewelry': 'Perhiasan', 'optician': 'Optik',
    'shoes': 'Sepatu', 'sports_shop': 'Toko Olahraga', 'toys': 'Mainan',
    'florist': 'Bunga', 'bicycle': 'Sepeda',
    'cinema': 'Bioskop', 'theatre': 'Teater', 'nightclub': 'Klub Malam',
    'karaoke': 'Karaoke', 'arts_centre': 'Galeri Seni', 'bowling': 'Bowling',
    'theme_park': 'Theme Park', 'attraction': 'Atraksi', 'viewpoint': 'Viewpoint',
    'museum': 'Museum', 'gallery': 'Galeri', 'zoo': 'Kebun Binatang',
    'aquarium': 'Akuarium',
    'clinic': 'Klinik', 'pharmacy': 'Apotek', 'hairdresser': 'Salon',
    'beauty': 'Beauty', 'massage': 'Pijat', 'fitness': 'Fitness',
    'sports': 'Olahraga', 'swimming': 'Kolam Renang',
    'bank': 'Bank', 'atm': 'ATM', 'post_office': 'Pos',
